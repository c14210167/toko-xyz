        ...
        <ul class="nav-menu">
            ...
            <?php if(auth()->guard()->check()): ?>
                <?php if(auth()->user()->user_type == 'customer'): ?>
                    <li><a href="<?php echo e(route('order.history')); ?>">Sejarah Order</a></li>
                <?php endif; ?>

                <li><a href="#" class="user-profile">👤 <?php echo e(auth()->user()->first_name); ?> <?php echo e(auth()->user()->last_name); ?></a></li>
                <li>
            ...
            <?php else: ?>
                ...
                <li><a href="<?php echo e(route('register')); ?>" class="btn-register">Daftar</a></li>
            <?php endif; ?>
        </ul>
    </div>
</nav>
...
<section id="home" class="hero">
    ...
    <div class="hero-content">
        ...
        <div class="hero-buttons">
            ...
            <?php if(auth()->guard()->check()): ?>
                <a href="<?php echo e(route('order.create')); ?>" class="btn btn-special">Create a New Order</a>
            <?php endif; ?>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="gallery-container">
            ...
            <div class="gallery-slide active">
                <img src="<?php echo e(asset('images/asus.jpg')); ?>" alt="ASUS">
            ...
            <div class="gallery-slide">
                <img src="<?php echo e(asset('images/lenovo.jpg')); ?>" alt="Lenovo">
                <div class="slide-content">
                    <h3>Lenovo</h3>
            ...
            <!-- Epson -->
            <div class="gallery-slide">
                <img src="<?php echo e(asset('images/epson.jpg')); ?>" alt="Epson">
                <div class="slide-content">
                    <h3>Epson</h3>
            ...
            <!-- Canon -->
            <div class="gallery-slide">
                <img src="<?php echo e(asset('images/canon.jpg')); ?>" alt="Canon">
                <div class="slide-content">
                    <h3>Canon</h3>
            ...
            <!-- Axioo -->
            <div class="gallery-slide">
                <img src="<?php echo e(asset('images/axioo.jpg')); ?>" alt="Axioo">
                <div class="slide-content">
                    <h3>Axioo</h3>
            ...
            <!-- MSI -->
            <div class="gallery-slide">
                <img src="<?php echo e(asset('images/msi.webp')); ?>" alt="MSI">
                <div class="slide-content">
                    <h3>MSI</h3>
            ...
            <!-- HP -->
            <div class="gallery-slide">
                <img src="<?php echo e(asset('images/hp.webp')); ?>" alt="HP">
                <div class="slide-content">
...
<?php /**PATH D:\XAMPP\htdocs\frontendproject\laravel-mode\resources\views/welcome.blade.php ENDPATH**/ ?>